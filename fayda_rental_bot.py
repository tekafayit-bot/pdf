...
API_KEY = os.environ.get("API_KEY", "rgw_your_api_key")
...
# Pricing
PRICE_PER_PDF = 5  # Birr
MINIMUM_PURCHASE = 150  # Birr (30 PDFs)
UNLIMITED_WEEK = 1000  # Birr
UNLIMITED_MONTH = 5000  # Birr
TRIAL_PDFS = 1  # Free trial
INVITE_BONUS = 2  # Free PDFs per invite
...
class UserData:
    ...
    first_name: str = ""
    last_name: str = ""
    balance: int = 0  # In Birr
    pdf_balance: int = 0  # Number of PDFs available
...
class Database:
    ...
    def get_user_payments(self, user_id: int) -> List[PaymentRequest]:
        with self.get_cursor() as cur:
            cur.execute("""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if not existing:
        ...
        # Send welcome with channel join prompt
...
async def handle_admin_menu(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if text == "📊 Statistics":
        ...
        # Handle admin actions that require input
...
# ===== HANDLE CANCEL IN CONVERSATIONS =====
...
def main():
    ...
    # Handle admin callbacks from main menu
